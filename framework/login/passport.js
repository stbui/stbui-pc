...
var login = {
    ...
    request: function () {
        var logindata = {
            autoResize: false,
            agentPageUrl: 'http://' + self.location.host + '/login_agent.html',
            callBack: 'loginok',
            redirectUrl: self.location.href,    // 登录成功后返回地址
            data: {
                domainName: 'www.eastmoney.com',
                deviceType: 'web',
                productType: 'dongcai',
                version: '16.0.0'
            }
        ...
        // 通行证接口地址
        var loginurl = 'https://exaccount.eastmoney.com/Home/WebLogin?request=' + encodeURIComponent(JSON.stringify(logindata));
        var loginhtml = '<iframe id="loginframe" frameborder="0" width="380" height="334" src=' + loginurl + '></iframe>';

        var loginmodal = new modalDialog({
            content: loginhtml
        });
